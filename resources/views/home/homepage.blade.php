                ...
                <div class="container pl-md-5 pr-md-5 pb-sm-3">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pl-sm-3 pt-sm-5 ">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pt-sm-3">
                                        <div class="card bg-transparent border-0">
                                            <img src="{{url('images/0001.png')}}" width="100%" height="100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item ">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pt-sm-3">
                                        <div class="card bg-transparent border-0">
                                            <img src="{{url('images/0002.png')}}" width="100%" height="100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pt-sm-3">
                                        <div class="card bg-transparent border-0">
                                            <img src="{{url('images/0003.png')}}" width="100%" height="100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row featurette">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="card bg-transparent border-0 ">
                        <img src="{{url('images/2.jpg')}}" width="" height="">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="card bg-transparent border-0">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="text-center col-lg-6">
                        <img class="featurette-image " src="{{url('images/india_map.png')}}" width="100%" height="300">
                    </div>
