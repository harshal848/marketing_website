            ...
            <div class="col-xs-12 col-sm-12 col-md-6 pl-sm-0 pl-md-0 pl-lg-5">
                ...
                <div class="row">
                    ...
                    <div class="col-9 pt-4 lead">
                        <span> <span class="font-weight-bold">Customers: </span> +91-20-46767345</span>
                    </div>
                    ...
                    <div class="col-9 pt-4 lead">
                        <span> <span class="font-weight-bold">Media & Investor: </span> +91 8470067555</span>
                    </div>
                        ...
                        <div class="card-body lead">
                            ...
                            <form action="{{ url('/forms/enquiry') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <option>DB Document Collection</option>
                                    <option>DB Debt Recovery</option>
                                    <option>DB Reg Teck API</option>
                                    <option>Other</option>
                                    </select>
                                </div>
                                <div class="form-group">
