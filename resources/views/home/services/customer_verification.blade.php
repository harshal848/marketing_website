   ...
   <div class="container p-5">
        ...
        <div class="row container">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 pb-3">
                <img src="{{url('images/customer_verification.png')}}" width="100%" height="100%">
            </div>
            <div id="customer_verification" class="col-xs-12 col-sm-12 col-md-7 col-lg-8 text-justify">
                ...
                <p class="lead">Financial services are always at highest to risk of fraud.
                    DocBoyz reliable and digitally evolved customer verification services are best tool to prevent fraud.
            ...
            <div class="col-2" style="width: 100px; height: 100px; padding: 0">
                <img src="{{url('images/aadhar_thumbnail.png')}}" width="100%" height="100%">
            </div>
            ...
            <div class="col-2" style="width: 100px; height: 100px; padding: 0">
                <img src="{{url('images/pan_thumbnail.png')}}" width="100%" height="100%">
            </div>
            <div class="col-10 text-justify">
            ...
            <div class="col-2" style="width: 100px; height: 100px; padding: 0">
                <img src="{{url('images/driving_license.png')}}" width="100%" height="100%">
            </div>
            <div class="col-10 text-justify">
            ...
            <div class="col-2" style="width: 100px; height: 100px; padding: 0">
                <img src="{{url('images/voter_id.png')}}" width="100%" height="100%">
            </div>
            <div class="col-10 text-justify">
            ...
            <div class="col-2" style="width: 100px; height: 100px; padding: 0">
                <img src="{{url('images/passport.png')}}" width="100%" height="100%">
            </div>
            <div class="col-10 text-justify">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
                <img src="{{url('images/bank.png')}}" width="100%" height="100%">
            </div>
            ...
            <div id="e_kyc" class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                ...
                <p class="text-justify">
                    <span class="lead">SEBI registered banking and financial services companies who wants to perform the transaction for investing in the financial market has to follow a process of
                        ...
                        DocBoyz API service ensure that "Know your client" information is extracted once Pan Card Number and Date of birst is provided.                    </span>
                </p>


            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <img src="{{url('images/kyc-services.jpg')}}" width="100%" height="100%">
            </div>

            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/newspaper.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div id="video_kyc" class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                ...
                <p class="text-justify">
                    <strong style="font-size: 125%">DocBOYZ Video KYC</strong>
                    <span class="lead">helps enterprises speed-up customer on-boarding process by automating the document collection and verification processes.
                        DocBoyz Video KYC includes a live video meeting with a client that builds up their presence during the KYC process, confirming their identity through the DocBoyz video KYC as per the government ID card and records it with the end goal of review and consistency.
                    </span>
                </p>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <img src="{{url('images/video-kyc.png')}}" width="100%" height="90%">
                <a class="text-dark" href="#demo"><h4 class="text-center pt-3 font-weight-bolder">Schedule a Demo</h4></a>
            </div>

            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/digital-solution-icon.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/Accuracy-icon.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/fast-reliable-icon.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/cost-effective-icon.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div id="e_sign" class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                ...
                <p>
                    <h3 class="font-weight-bold text-justify">Get Your KYC Done in Minutes With DocBoyz e-Sign</h3>
                </p>
                <p class="text-justify">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <img src="{{url('images/esign.jpg')}}" width="100%" height="100%">
            </div>

            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/api.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/workflow.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div id="offline_aadhar" class="col-xs-12 col-sm-12 col-md-8 col-lg-7">
                ...
                <p>
                    <h3 class="font-weight-bold text-justify">DocBoyz Offline Aadhaar KYC for enterprises</h3>
                </p>
                <p class="text-justify lead">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                <img src="{{url('images/offlineaadhar.png')}}" width="100%" height="90%">
                <a class="text-dark" href="#demo"><h4 class="text-center pt-3 font-weight-bolder">Schedule a Demo</h4></a>
            </div>
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/security.jpg')}}">
                </div>
                <div class="col-md-9">
                    <h5 class="font-weight-bold">Security</h5>
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/inclusion.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div id="aadhar_masking" class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                ...
                <p class="text-justify">
                    <span class="font-weight-bold" style="font-size: 125%"><span class="text-danger">Doc</span><span class="text-dark">Boyz</span></span>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <img src="{{url('images/mask-adhar.png')}}" width="100%" height="90%">
                <a class="text-dark" href="#demo"><h4 class="text-center pt-3 font-weight-bolder">Schedule a Demo</h4></a>
            </div>

            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/precisely-accurate.png')}}">
                </div>
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/realtime-icon.png')}}">
                </div>
                <div class="col-md-9 pt-md-3">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/trusted-icon.png')}}">
                </div>
                <div class="col-md-9 pt-md-3">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/image-format-icon.png')}}">
                </div>
                <div class="col-md-9 pt-md-3">
            ...
            <div id="db_fmatch" class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                ...
                <p class="text-justify lead">
                    Be assure that two pictures are of a similar individual with the best in class DocBoyz Face Match algorithm using artificial intelligence and machine learning. It verifies, analyses and identifies faces in real-time.
                </p>
                <p class="text-justify lead">
                    DocBoyz algorithm excels in every challenging situation including light and angle variability, blur and pixelation, age, and gender.
                </p>
                <p class="text-justify lead">
                    DocBoyz empowers enterprises who need face match that is accurate in testing situations to give unrivalled degrees of security, ongoing execution, and can be used in any given conditions.
                </p>
                <p class="text-justify lead">
                    DocBoyz Face match helps in protecting individuals and organisations against frauds and mitigations where an attacker is using video, images, or masks to spoof a system 100% Accuracy Industry-leading performance with challenging angles and lighting conditions
                </p>

            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                <img class="pt-lg-5" src="{{url('images/facematch.png')}}" width="100%" height="80%">
                <a class="text-dark" href="#demo"><h4 class="text-center pt-3 font-weight-bolder">Schedule a Demo</h4></a>
            </div>
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/age-estimation-icon.png')}}">
                </div>
                <div class="col-md-9 pt-md-3">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/emotions-detection.png')}}">
                </div>
                <div class="col-md-9 pt-md-3">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{url('icons/affordable-icon.png')}}">
                </div>
                <div class="col-md-9 pt-md-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <img src="{{url('images/enach.jpg')}}" width="100%" height="100%">
            </div>
