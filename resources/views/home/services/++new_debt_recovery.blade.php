   ...
   <div class="container p-5">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7 lead">
                <ul class="list-unstyled">
                    ...
                    <li> <span class="font-weight-bold">&#10003;</span> Cloud-Based Perdictive Calling</li>
        ...
        <div class="row text-center" style="font-size: 16px">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-3">
                ...
                <h4 class="font-weight-bolder">2. Perdictive Calling</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/flexibility.jpg')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/control-icon.jpg')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/secured-icon.jpg')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/realtime-results-icon.jpg')}}">
                </div>
                <div class="col-md-9">
