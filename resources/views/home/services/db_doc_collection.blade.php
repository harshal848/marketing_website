    ...
    <div class="container p-5">
        ...
        <div class="row pl-lg-5 pr-lg-5 justify-content-center pt-2 text-center">
                ...
                <div class="card col-sm-6 col-md-4 col-lg-3 pt-md-0" style="width: 12rem; height: 10rem;">
                    <img src="{{url('icons/integration.svg')}}" class="card-img-top mt-sm-3" width="70" height="70">
                    <div class="card-body">
                ...
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/fraud_detection.svg')}}" class="card-img-top mt-sm-3" width="70" height="70">
                    <div class="card-body">
                        <h5>Fraud Detection</h5>
                    </div>
                </div>
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/data_encryption.svg')}}" class="card-img-top mt-xl-4" width="80" height="80">
                    <div class="card-body">
                ...
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/stopwatch.svg')}}" class="card-img-top mt-sm-3" width="70" height="70">
                    <div class="card-body">
                ...
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/data_security.svg')}}" class="card-img-top mt-sm-3" width="75" height="75">
                    <div class="card-body">
                        <h5>Secured</h5>
                    </div>
                </div>
                ...
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/audit.svg')}}" class="card-img-top mt-sm-3" width="70" height="70">
                    <div class="card-body">
                        <h5>Transparent process</h5>
                    </div>
                </div>
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/rocket.svg')}}" class="card-img-top mt-sm-3" width="75" height="75">
                    <div class="card-body">
                        <h5>Fast</h5>
                    </div>
                </div>
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/real_time_tracking.svg')}}" class="card-img-top mt-sm-3" width="75" height="75">
                    <div class="card-body">
                        <h5>Real Time Tracking</h5>
                    </div>
                </div>
                <div class="card col-sm-6 col-md-4 col-lg-3" style="width: 12rem; height: 10rem;">
                    <img src="{{asset('icons/network.svg')}}" class="card-img-top mt-sm-3" width="70" height="70">
                    <div class="card-body">
