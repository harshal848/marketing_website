   ...
   <div class="container p-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/flexibility.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/control-icon.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/secured-icon.png')}}">
                </div>
                <div class="col-md-9">
            ...
            <div class="col-lg-6 pt-4 row text-center text-sm-center text-md-left text-lg-left">
                <div class="col-md-3">
                    <img src="{{asset('icons/realtime-results-icon.png')}}">
                </div>
                <div class="col-md-9">
