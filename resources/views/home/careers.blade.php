    ...
    <div class="container pl-5 pr-5 pt-3 pb-4">
        ...
        <div class="row pl-sm-0 pl-md-5 pr-sm-0 pr-md-5">
            ...
            <div class="col-sm-12 col-lg-6">
                ...
                <p>
                    <h2 class="font-weight-bold"><span class="text-dark">Be a Part of </span> <span class="text-danger">DocBoyz family</span></h2>
                </p>
                <p class="text-justify lead">
                    <span class="font-weight-bold">DocBoyz</span> started its journey in 2018 to create a new wave in Fintech logistics sector.
