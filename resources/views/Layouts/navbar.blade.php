<div class="container">
 ...
 <nav class="navbar navbar-expand-lg navbar-light" style="font-size: 16px; font-weight: bold">
    <a class="d-flex" href="{{ url('/')}}">
        <img src="{{asset('logos/DocBoyz.png')}}" height="40px">
        <img class="pt-2 pl-2" src="{{asset('logos/DocBoyz1.png')}}">
    </a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse pl-sm-5" id="navbarText">
      <ul class="navbar-nav ml-sm-auto ml-md-auto ml-lg-auto">
        ...
        <li class="nav-item">
            <a class="nav-link text-dark text-decoration-none" href="{{ url('/blog')}}">Blog</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-dark text-decoration-none" href="{{ url('/contact')}}">ContactUs</a>
        </li>
      </ul>

      <div class="ml-sm-auto ml-md-auto ml-lg-auto d-flex">
